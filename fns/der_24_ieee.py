...
class der_24_ieee():
    ...
    def __init__(self):
        ...
        self.num_buses = 29
        self.num_secondary_agents = 11
        self.bess_bus_ids = [4, 24, 32, 66, 80]
        self.build_network()
    ...
    def build_network(self):
        ...
        #     if i % 2 == 0:
        #         pp.create_load(net, buses[bus_idx], p_mw=15, q_mvar=4, scaling=1.0, name=f"Load_{i+1}")
        #     else:
        #         pp.create_load(net, buses[bus_idx], p_mw=17, q_mvar=4, scaling=1.0, name=f"Load_{i+1}")
        ...
        #         net, bus=buses[bus_idx], p_mw=30, max_e_mwh=50.0, min_e_mwh=15,
